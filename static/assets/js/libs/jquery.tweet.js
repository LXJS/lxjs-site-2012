...
(function (factory) {
  ...
  $.fn.tweet = function(o){
    ...
    function extract_template_data(item){
      ...
      o.time = t('<header><h3><a href="{tweet_url}" title="View tweet on twitter"><time datetime="2012-01-25">{tweet_relative_time}</time></a></h3></header>', o);
    ...
    return this.each(function(i, widget){
      var list = $('<ul class="tweet_list border_list">');
      ...
      $(widget).unbind("tweet:load").bind("tweet:load", function(){
        ...
        $.getJSON(build_api_url(), function(data){
          ...
          list.append($.map(tweets, function(o) { return "<li><article>" + t(s.template, o) + "</article></li>"; }).join('')).
